...
//      if(gameState.id==0){if(gameState.turn==1)start = System.currentTimeMillis();
//      if(gameState.turn==360)TestAgent.message(""+(System.currentTimeMillis()-start),0,"test_time");
//      }
